...
const CARD_ASPECT_W = 374;
const CARD_ASPECT_H = 256;
const BG_H_RATIO = 200 / 256;
const ROLE_W_RATIO = 183 / 374;
const OPTIMAL_WH_RATIO = 1.5; // height = width / 1.5
...
const WorldLineCard = optimize(({ id, onPressItem }: WorldLineCardProps) => {
    ...
    return (
        ...
        >
            {/* ── content area (aspect ratio 374:256) ── */}
            <div
                style={{
                    position: 'relative',
                    width: '100%',
                    paddingTop: `${(CARD_ASPECT_H / CARD_ASPECT_W) * 100}%`,
                }}
            >
                <div style={{ position: 'absolute', inset: 0 }}>
                    ...
                    {/* gradient overlay: transparent → bgColor */}
                    <div
                        style={{
                            position: 'absolute',
                            inset: 0,
                            height: `${BG_H_RATIO * 100}%`,
                            background: `linear-gradient(to bottom, ${bgColor}00, ${bgColor}CC)`,
                            pointerEvents: 'none',
                        }}
                    />
                    ...
                    {coverRoles.length === 1 && coverRoles[0]?.uri && (
                        <img
                            ...
                            style={{
                                position: 'absolute',
                                right: 0,
                                bottom: `${(1 - BG_H_RATIO) * 100}%`,
                                width: `${ROLE_W_RATIO * 100}%`,
                                aspectRatio: `1 / ${OPTIMAL_WH_RATIO}`,
                                objectFit: 'cover',
                                pointerEvents: 'none',
                            }}
                        />
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <path
                                            d="M2 2.5C2 1.67 2.67 1 3.5 1H11.5C11.78 1 12 1.22 12 1.5V10.5C12 10.78 11.78 11 11.5 11H3.5C3.22 11 3 11.22 3 11.5C3 11.78 3.22 12 3.5 12H12V13H3.5C2.67 13 2 12.33 2 11.5V2.5Z"
                                            fill="#EDEDED"
                                        />
                                        <path
                                            d="M4.5 3.5H9.5V4.5H4.5V3.5ZM4.5 5.5H8V6.5H4.5V5.5Z"
                                            fill="#EDEDED"
                                        />
                                    </svg>
                                    <span
    ...
    if (ids.length === 0) {
        return (
            ...
            >
                ...
                >
                    <path
                        d="M8 8C8 5.79 9.79 4 12 4H40C40.55 4 41 4.45 41 5V38C41 38.55 40.55 39 40 39H12C11.45 39 11 39.45 11 40C11 40.55 11.45 41 12 41H41V44H12C9.79 44 8 42.21 8 40V8Z"
                        fill="#EDEDED"
                        fillOpacity="0.2"
                    />
                </svg>
