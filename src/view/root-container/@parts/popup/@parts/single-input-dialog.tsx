...
interface Props { info: PopupTypes.SingleInputDialogInfo | null; onClose: () => void }

export const SingleInputDialog = optimize(({ info, onClose }: Props) => {
                        ...
                        <RadixDialog.Content asChild>
                            ...
                            >
                                ...
                                <input
                                    ...
                                    className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-text-primary text-sm outline-none focus:border-white/30 mb-4"
